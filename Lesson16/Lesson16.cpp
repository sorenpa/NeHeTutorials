/*
Simple Fog effects:
1: Simply setup the fog with GL functions ->
...
2: A better effect can be optained by setting the background color to the color of the fog.
...
void init ( GLvoid )     // Create Some Everyday Functions
{
	...
	//Fog
	glClearColor(0.4f,0.4f,0.4f,1.0f);          // We'll Clear To The Color Of The Fog ( Modified )
